...
### Nautobot 3.1.0 API Facts (verified against live instance at nautobot.example.com)
...
- The Nautobot instance at nautobot.example.com is the target deployment with 3 devices (HomeSwitch01, HomeSwitch02, pfSense-FW01), 34 VLANs, 2 prefixes, and 2 cables.
