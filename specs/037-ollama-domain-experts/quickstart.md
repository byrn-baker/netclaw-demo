...
- Ollama running on your AI host (`http://your-ollama-host:11434`) ✅ Already confirmed
...
On your Ollama host (your-ollama-host):
...
async def test():
    c = OllamaClient('http://your-ollama-host:11434')
...
"ollama-experts": {
  ...
  "env": {
    "OLLAMA_BASE_URL": "${OLLAMA_BASE_URL:-http://your-ollama-host:11434}",
...
The Ollama MCP is already configured in your Kiro (`~/.kiro/settings/mcp.json`) pointing to `your-ollama-host:11434`. To add the **domain expert** MCP alongside it, add this entry:
