...
For the user's setup (your-ollama-host:11434), the available GPU memory determines which models can run simultaneously. Ollama handles model loading/unloading automatically but swapping is slow (~10-30s).
