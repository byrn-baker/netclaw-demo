...
**Purpose**: Build the specialized models on your-ollama-host using curated system prompts
...
- [ ] T005 Verify all models appear in `ollama list` on your-ollama-host
...
- [ ] T029 [US5] Verify the existing Ollama MCP in Kiro works with your-ollama-host:11434 ✅ CONFIRMED
