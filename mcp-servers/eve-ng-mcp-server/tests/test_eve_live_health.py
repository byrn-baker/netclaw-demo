...
Target profiles:
  ...
  external uses EVE_EXTERNAL_URL, defaulting to http://eve-ng.lab.local.
...
Environment overrides:
  ...
  EVE_EXTERNAL_URL=http://eve-ng.lab.local
  EVE_EXTERNAL_CONSOLE_HOST=eve-ng.lab.local
...
def _apply_target_profile(target: str) -> None:
    ...
    if target == "external":
        os.environ["EVE_URL"] = os.getenv("EVE_EXTERNAL_URL", "http://eve-ng.lab.local")
        os.environ["EVE_CONSOLE_HOST"] = os.getenv("EVE_EXTERNAL_CONSOLE_HOST", "eve-ng.lab.local")
