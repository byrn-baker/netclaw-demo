...
That's it. The installer deploys 111 skills, installs bundled MCP dependencies, and prepares configuration for 50 MCP integrations, then launches a two-phase setup:
